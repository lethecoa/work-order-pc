...
import ChangePwdModel from '../Modal/ChangePwdModel';

const Header = ({dispatch, user, loading, userType}) => {
   ...
   * @param newPwd
   */
  const saveNewPwd = (password) => {
    dispatch({type: fun.fuse(model.app, action.changePwd), payload: {password}});
  };
  return (
    <div className={styles.normal}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.btnBg}>
          ...
          &nbsp;&nbsp;&nbsp;<ChangePwdModel pwd={user.password} loading={loading} saveNewPwd={saveNewPwd}/>
