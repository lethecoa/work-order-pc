...
function Sidebar({pathname, user}) {
  ...
  return (
    <div className={styles.menu}>
      ...
      {userType === config.userType.worker &&
      <Menu
        defaultSelectedKeys={[pathname]}
        defaultOpenKeys={['2']}
        mode="inline"
      ...
      >
        <SubMenu key="2" title={<span className={styles.menuItem}>
						<i className={styles.wof1 + ' ' + styles['woc-xuqiudengji']}/>
						<span className={styles.m1}>账号管理</span></span>}>
          <Menu.Item key={modular.doctorAccount.url}>
							<span className={styles.menuItem}>
								<i className={styles.wof3 + ' ' + styles['woc-untreated']}/>
								<span className={styles.m3}>{modular.doctorAccount.cn}</span></span>
          </Menu.Item>
          <Menu.Item key={modular.workerAccount.url}>
							<span className={styles.menuItem}>
								<i className={styles.wof3 + ' ' + styles['woc-finished']}/>
								<span className={styles.m3}>{modular.workerAccount.cn}</span></span>
          </Menu.Item>
        </SubMenu>
      </Menu>}
    </div>
