  ...
  const routes = [
    {
      ...
      childRoutes: [
        ...
        },
        {
          ...
          name: modular.doctorAccount.name,
          getComponent(nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('../models/adminModel'));
              cb(null, require('./Admin/DoctorAccount'));
            });
          },
        },
        {
          path: modular.workerAccount.url,
          name: modular.workerAccount.name,
          getComponent(nextState, cb) {
            require.ensure([], (require) => {
              registerModel(app, require('../models/adminModel'));
              cb(null, require('./Admin/WorkerAccount'));
            });
          },
        },
      ]
